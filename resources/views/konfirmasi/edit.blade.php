...
@section('title', 'Update Konfirmasi')
    ...
    <div class="col col-lg-6 col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          ...
          @endif
          <form action="{{ route('konfirmasi.update', $itemkonfirmasi->id) }}" method="post">
            @csrf
            {{ method_field('patch') }}
            ...
            <div class="form-group">
              ...
              <select name="status" id="status" class="form-control">
                <option value="publish" {{ $itemkategori->status == 'publish'? 'selected': ''}}>belum divalidasi</option>
                <option value="unpublish" {{ $itemkategori->status == 'unpublish'? 'selected': ''}}>sudah divalidasi</option>
              </select>
            </div>
            <div class="form-group">
