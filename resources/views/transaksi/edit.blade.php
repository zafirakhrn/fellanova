...
@section('content_header')
    <h1 class="m-0 text-dark">Edit Data Order</h1>
@stop
@section('content')
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <input type="hidden" name="status_pembayaran" id="status_pembayaran" class="form-control" value="{{ $itemorder->cart->status_pembayaran }}">
                  </td>
                </tr>
                <tr>
                  <td>
