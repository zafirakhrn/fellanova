...
<head>
  ...
  <title>Fellanova Furniture</title>
  <link href="css/bootstrap.css" rel="stylesheet">
  <link rel="icon" href="/image/daybed.png">
  ...
  <nav style="background-color: #fefefe !important; padding: 0; justify-content: space-between;box-shadow: 0 0.25rem 0.25rem rgba(0, 0, 1, 0.025); margin-bottom:0 !important;" class="navbar navbar-expand-lg">
    <nav style="display: contents; padding: 0; justify-content: space-between; margin: 0;" class="navbar navbar-expand-lg">
      <div style="display: flex; flex-direction: row; margin-inline-end: auto;">
        ...
        <nav class="navbar navbar-expand-lg" style="font-family:Roboto;font-size: large;margin-top:10px;">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('products.list')}}" style="margin-left:20px;">Produk</a>
              </li>
              <li class="nav-item">
              ...
              @endif
              <li class="nav-item">
                <a class="nav-link" href="/custom" style="margin-left:20px;">Custom Furniture</a>
              </li>
   </li>
   </ul>
          </div>
