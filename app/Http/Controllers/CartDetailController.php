...
class CartDetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $cekdetail = CartDetail::where('cart_id', $itemcart->id)
                                ...
                                ->first();
        $quantity = 1;// diisi 1, karena kita set ordernya 1
        ...
        if ($cekdetail) {
            ...
            $cekdetail->updatedetail($cekdetail, $quantity, $harga);
            ...
            $inputan['gambar'] = $itemproduk->gambar;
            $inputan['quantity'] = $quantity;
            $inputan['harga'] = $harga;
            $inputan['subtotal'] = ($harga * $quantity);            
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($param == 'tambah') {
            // update detail cart
            $quantity = 1;
            $itemdetail->updatedetail($itemdetail, $quantity, $itemdetail->harga);
            // update total cart
